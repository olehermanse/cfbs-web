...
ADD https://github.com/gohugoio/hugo/releases/download/v0.110.0/hugo_0.110.0_Linux-64bit.tar.gz hugo.tar.gz
RUN echo "a1c97b69a96040e0911f8ce8c9718553c333727b5ffa969e59635837e3b4dcc3  hugo.tar.gz" | sha256sum -c
